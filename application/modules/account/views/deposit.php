...
<section class="categories-grid-section spad">
        <div class="row" style="margin-right: 0px;">
            ...
            <div class="col-md-8 pl-5 ml-5" style="color: white">
                <div class="row">
                    <div class="col-md-12">
                        <h4 style="color: white">Deposit Methods</h4>
                    </div>
                </div>
                <div class="row" style="background-color: #540000; border-radius: 5px;">
                    <div class="col-md-3">
                        <a href="#"><img src="<?=STATIC_FRONT_IMAGE?>visa.png"></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="<?=STATIC_FRONT_IMAGE?>jazzcash.png"></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="<?=STATIC_FRONT_IMAGE?>payoneer.png"></a>
                    </div>
                </div>
            </div>
        </div>

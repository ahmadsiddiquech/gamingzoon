               ...
               <div class="row" style="margin-top:15px;">
                       <div class="col-sm-5">
                        <div class="form-group">
                          ...
                          <?php echo form_label('Account Head<span style="color:red">*</span>', 'name', $attribute); ?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8"> 
                            <select name="type" id="type" required="required" class="form-control" tabindex="4">
                              ...
                              <option value="Employee" <?php if($news['type']=='Employee') echo "selected"; ?>>Employee</option>

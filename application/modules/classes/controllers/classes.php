...
Modules::run('site_security/has_permission');
    ...
    function create() {
        ...
        $arr_roles = Modules::run('program/_get_by_arr_id_programs',$outlet_id)->result_array();
    ...
    function submit() {
        ...
        $user_data = $this->session->userdata('outlet_id');
        if ($update_id != 0) {
    ...
    function _update($arr_col, $outlet_id, $data) {
        $this->load->model('mdl_classes');
        $this->mdl_classes->_update($arr_col, $outlet_id, $data);
    }
    ...
    function _delete($arr_col, $outlet_id) {       
        $this->load->model('mdl_classes');
        $this->mdl_classes->_delete($arr_col, $outlet_id);
    }

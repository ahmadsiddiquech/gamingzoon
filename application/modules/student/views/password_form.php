                ...
                <div class="portlet-body form"> 
                  ...
                  <?php
                                    ...
                                    if (isset($hidden) && !empty($hidden))
                                        echo form_open_multipart(ADMIN_BASE_URL . 'student/change_pass/' . $update_id , $attributes, $hidden);
                                    else
                                        echo form_open_multipart(ADMIN_BASE_URL . 'student/change_pass/' . $update_id , $attributes);
                                    ?>

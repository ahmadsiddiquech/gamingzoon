...
Modules::run('site_security/has_permission');
    ...
    function print_test(){
        ...
        $test = $this->_get_test_print_voucher($test_id,$outlet_id)->result_array();
    ...
    function marks() {
        ...
        $data['update_id'] = $update_id;
        $student_list = $this->_get_class_student_list($update_id,$outlet_id)->result_array();
    ...
    function submit() {
            ...
            $arr_teacher = Modules::run('subjects/_get_subject_teacher',$data['subject_id'],$data['outlet_id'])->result_array();
    ...
    function _update($arr_col, $outlet_id, $data) {
        $this->load->model('mdl_test');
        $this->mdl_test->_update($arr_col, $outlet_id, $data);
    }
    ...
    function _delete($arr_col, $outlet_id) {       
        $this->load->model('mdl_test');
        $this->mdl_test->_delete($arr_col, $outlet_id);
    }
    ...
    function _get_class_student_list($update_id,$outlet_id){
        $this->load->model('mdl_test');
        return $this->mdl_test->_get_class_student_list($update_id,$outlet_id);
    }
    ...
    function _get_test_print_voucher($test_id,$outlet_id){
        $this->load->model('mdl_test');
        return $this->mdl_test->_get_test_print_voucher($test_id,$outlet_id);
    }

    function _get_org_print_voucher($outlet_id){
        $this->load->model('mdl_test');
        return $this->mdl_test->_get_org_print_voucher($outlet_id);
    }
}
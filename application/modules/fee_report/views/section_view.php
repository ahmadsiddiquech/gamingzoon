            ...
            <div class="tab-pane  active" >
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/section_fee_submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/section_fee_submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body">
              ...
              <div class="row" style="margin-top: 15px;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            ...
                            foreach ($programs as $key => $value):?>
                              <option value="<?php echo $value['id'].','.$value['name'] ?>"><?=$value['name'];?></option>
                            <?php endforeach; ?>
                          </select>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-5">
                        ...
                        echo form_label('Class', 'class_id', $attribute);?>
                        <div class="col-md-8">
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        ...
                        <?php
                        $attribute = array('class' => 'control-label col-md-4');
                        echo form_label('Section', 'section_id', $attribute);?>
                        <div class="col-md-8">

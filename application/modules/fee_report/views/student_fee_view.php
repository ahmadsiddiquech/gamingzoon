                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/student_fee_submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/student_fee_submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body">
              <div class="row" style="margin-top:15px;">
                <div class="col-sm-5">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <select name="student_id" id="student_id" class="form-control chosen1">
                        <option value=""></option>
                        <?php if(isset($student) && !empty($student))
                        foreach ($student as $key => $value):?>
                          <option value="<?php echo $value['id'].','.$value['name']?>"><?php echo $value['id'].' - '.$value['name'].' - '.$value['parent_name'];?></option>
                        <?php endforeach; ?>
                      </select>
                      </div>
                    </div>

...
<div class="container mt-2 img-opacity">
  ...
  <div class="col-md-12" style="text-align: center;"><h1>Section Fee Report</h1></div>
  <div class="row mt-5">
    <div class="col-md-4">
      <h5>Program Name: <span class="s-span"> <?=$report[0]['program_name']; ?></span></h5>
    </div>
    <div class="col-md-4">
      <h5>Class Name: <span class="s-span"> <?=$report[0]['class_name']; ?></span></h5>
    </div>
    <div class="col-md-4">
      <h5>Section Name: <span class="s-span"> <?=$report[0]['section_name']; ?></span></h5>
    </div>
  </div>
  <div class="row mt-2">
    <div class="col-md-6">
  ...
  <table width="100%" class="mt-5">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo date("d-F-Y", strtotime($value['due_date']));?></td>

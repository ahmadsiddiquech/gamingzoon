  ...
  <div class="page-content"> 
    <div class="content-wrapper">
      ...
      <h3>
        <?php 
        if (empty($update_id)) 
                    $strTitle = 'Employee Salary Report';
                else 
                    $strTitle = 'Employee Salary Report';
                    echo $strTitle;
                    ?>
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/employee_submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'fee_report/employee_submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body">
              ...
              <div class="row" style="margin-top:15px;">
                <div class="col-sm-5">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <select name="employee_id" id="employee_id" class="form-control chosen1" required="required">
                        <option value=""></option>

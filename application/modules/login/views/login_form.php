    ...
    <?php echo form_open(ADMIN_BASE_URL.'login/submit_login'); ?>
      <fieldset>
        ...
        <div class="form-group" style="margin-bottom: 10px;">
                    <input type="text" name="txtUserName" id="email" class="form-control input-lg custom-radius" placeholder="Email Address">
        </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-sm-6 col-md-6">
            <a href="" class="btn btn-lg btn-primary btn-block custom-radius">Register</a>
          </div>
        </div>
      </fieldset>
    </form>

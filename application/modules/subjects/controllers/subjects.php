...
//Modules::run('site_security/has_permission');
    ...
    function _get_data_from_post() {
        ...
        $data['s_type'] = 'Mandatory';
        $data['amount'] = $this->input->post('amount');
        $data['cut'] = $this->input->post('cut');
        $user_data = $this->session->userdata('user_data');
    ...
    function _update($arr_col, $outlet_id, $data) {
        $this->load->model('mdl_subject');
        $this->mdl_subject->_update($arr_col, $outlet_id, $data);
    }
    ...
    function _delete($arr_col, $outlet_id) {       
        $this->load->model('mdl_subject');
        $this->mdl_subject->_delete($arr_col, $outlet_id);
    }
    ...
    function _get_subject_section($section_id){
        $this->load->model('mdl_subject');
        return $this->mdl_subject->_get_subject_section($section_id);
    }

    function _get_subject_teacher($subject_id,$outlet_id) {
        $this->load->model('mdl_subject');
        return $this->mdl_subject->_get_subject_teacher($subject_id,$outlet_id);
    }
}
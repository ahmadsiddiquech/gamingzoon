                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    foreach ($news->result() as
                                        ...
                                        $set_publish_url = ADMIN_BASE_URL . 'subjects/set_publish/' . $new->id;

                                        $set_unpublish_url = ADMIN_BASE_URL . 'subjects/set_unpublish/' . $new->id ;

                                        $edit_url = ADMIN_BASE_URL . 'subjects/create/' . $new->id ;

                                        $delete_url = ADMIN_BASE_URL . 'subjects/delete/' . $new->id;
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo wordwrap($new->teacher_name)  ?></td>
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit subjects'));



                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete subjects'));
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              ...
              $.ajax({
                        ...
                        url: "<?php ADMIN_BASE_URL?>subjects/detail",
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                title : "Are you sure to delete the selected subjects?",
                ...
                function () {
                       ...
                       $.ajax({
                            ...
                            url: "<?php echo ADMIN_BASE_URL?>subjects/delete",
                ...
                swal("Deleted!", "subjects has been deleted.", "success");
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             ...
             $.ajax({
                ...
                url: "<?= ADMIN_BASE_URL ?>subjects/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php ADMIN_BASE_URL?>subjects/manage');
